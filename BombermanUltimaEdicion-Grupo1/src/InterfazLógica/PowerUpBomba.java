...
/**
 * Esta clase se encarga de gestionar unicamente el PowerUp de Bombas Extra.
 */
public class PowerUpBomba extends PowerUp {
    public PowerUpBomba(int posicionX, int posicionY, int nivel, Sprite sprite) {
